...
| **PH4** | **SPA化+認証・認可** | ①SPA化=**完了**(PR #11) ②Cognito認証=**完了**(PR #13。infra/auth別スタック・SRP自前ログイン画面・WS認証・sv/operatorロール) ③残り=**認可**: broadcastの宛先化+API側の絞り込み+SVビュー/応対者ビュー(3.1〜3.3)。**認証≠認可**——現状は「誰か」を確定しただけで、認証済みなら全呼が見える |
